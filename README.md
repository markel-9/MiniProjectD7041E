...
### Advanced model
The program did a fairly good job, the main issues we saw were some inaccuracy in the shade the colors(T1) were and sometimes the backgrounds had innacurate colors(T2). 
